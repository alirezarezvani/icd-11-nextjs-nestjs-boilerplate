/**
 * Login Form Component for ICD-11 Healthcare Platform
 */
...
export const LoginForm: React.FC<LoginFormProps> = ({
  ...
  const containerSx = isModal 
    ...
    : { mt: 1, maxWidth: 400, mx: 'auto' };

  return (
    <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={containerSx}>
