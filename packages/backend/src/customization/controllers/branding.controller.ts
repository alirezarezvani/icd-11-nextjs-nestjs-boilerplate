...
export class BrandingController {
  ...
  @ApiResponse({
    status: 200,
    description: "Organization branding retrieved successfully",
  })
  @ApiResponse({
    status: 404,
    description: "Organization or branding not found",
  })
  async getBranding(
  ...
  @ApiResponse({
    status: 201,
    description: "Organization branding created successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Organization branding reset successfully",
  })
  @ApiResponse({ status: 404, description: "Organization not found" })
  ...
  async resetBranding(
    ...
    await this.brandingService.resetBranding(
      organizationId,
      resetBy,
      userEmail,
    );
  ...
  @ApiResponse({
    status: 200,
    description: "CSS variables generated successfully",
  })
  @ApiResponse({
    status: 404,
    description: "Organization or branding not found",
  ...
  @Get("mui-theme")
  @ApiOperation({
    summary: "Get Material-UI theme configuration for organization branding",
  })
  @ApiParam({ name: "organizationId", description: "Organization ID" })
  @ApiResponse({
    status: 200,
    description: "Material-UI theme configuration generated successfully",
  })
  @ApiResponse({
    status: 404,
    description: "Organization or branding not found",
